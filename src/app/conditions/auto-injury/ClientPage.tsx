...
export default function AutoInjuryPage() {
    ...
    return (
        <div className="container mx-auto px-4 py-16 max-w-4xl">
            <PersonalizationTracker interest="Auto Injury" />
            <Link href="/" className="inline-flex items-center text-sm text-zinc-500 hover:text-gold mb-8">
                <ArrowLeft className="mr-2 h-4 w-4" /> {t.pages.autoInjuryPage.backLink}
            </Link>

            <h1 className="text-4xl font-bold text-zinc-900 dark:text-zinc-50 mb-6">
                {t.pages.autoInjuryPage.title}
            </h1>

            <div className="prose dark:prose-invert max-w-none">
                <p className="text-xl text-zinc-600 dark:text-zinc-300 mb-8">
                    {t.pages.autoInjuryPage.intro}
                </p>

                <h2 className="text-2xl font-semibold mt-8 mb-4">{t.pages.autoInjuryPage.insurance.title}</h2>
                <p>
                    {t.pages.autoInjuryPage.insurance.text}
                </p>

                <h2 className="text-2xl font-semibold mt-8 mb-4">{t.pages.autoInjuryPage.common.title}</h2>
                <ul className="list-disc pl-6 space-y-2 mb-8">
                    <li>{t.pages.autoInjuryPage.common.whiplash}</li>
                    <li>{t.pages.autoInjuryPage.common.back}</li>
                    <li>{t.pages.autoInjuryPage.common.headaches}</li>
                    <li>{t.pages.autoInjuryPage.common.shoulder}</li>
                </ul>
            </div>
