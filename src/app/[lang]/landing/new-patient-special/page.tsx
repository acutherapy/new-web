...
export default function SpecialOfferPage() {
    return (
        <main className="min-h-screen bg-slate-50 font-sans text-slate-900">
            {/* Background elements are now moved to a proper Hero section below */}
            ...
            {/* --- Hero Section --- */}
            <section className="relative pt-8 pb-16 md:pt-16 md:pb-24 bg-[#1e293b]">
            ...
            {/* --- Doctors Section --- */}
            <section className="bg-white py-16 md:py-24 border-t border-slate-200 relative z-10">
            ...
            {/* --- Footer (Unified) --- */}
            <footer className="bg-[#1e293b] text-slate-400 py-12 border-t border-slate-800 relative z-10">
