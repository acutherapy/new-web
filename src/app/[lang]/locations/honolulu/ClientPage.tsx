...
export default function HonoluluLocationPage() {
    const { t } = useLanguage();
    const info = t.pages.locations.honolulu;
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                    ...
                    <div className="h-[400px] lg:h-auto min-h-[400px] rounded-2xl overflow-hidden shadow-lg border border-zinc-200 dark:border-zinc-800 relative bg-zinc-100 dark:bg-zinc-800">
                        <iframe
                            ...
                            src={`https://maps.google.com/maps?q=1650%20Liliha%20St%2C%20Honolulu%2C%20HI%2096817&t=m&z=15&output=embed&iwloc=near`}
                        ></iframe>
                    </div>

                </div>
            </div>
            <Reviews category="Honolulu" />
        </div>
    );
}
